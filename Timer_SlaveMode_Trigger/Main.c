//*************************************************SLAVE MODE TRIGGER MODE PRACTISE***************************************************************************//
...
void TIM5_Init()
{
	...
	TIM5->SMCR	|=	(3<<1);		//	Trigger Mode - The counter starts at a rising edge of the trigger TRGI (but it is not reset). Only the start of the counter is controlled.
